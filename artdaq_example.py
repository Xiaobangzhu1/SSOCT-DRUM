...
from artdaq.constants import Edge, ProductCategory, RegenerationMode
...
class AODO(object):
    ...
    def config(self):
        ...
        self.AOtask.ao_channels.add_ao_voltage_chan(physical_channel='Robot/ao2', \
        ...
        self.AOtask.triggers.start_trigger.cfg_dig_edge_start_trig("/Robot/PFI0")
        
        # terminal_name = get_terminal_name_with_dev_prefix(self.AOtask, "ao/StartTrigger")

    
        self.DOtask.do_channels.add_do_chan(lines='Robot/port0/line0:7')
        self.DOtask.timing.cfg_samp_clk_timing(rate=100000, \
                                        source='/Robot/PFI0', \
                                            # active_edge= Edge.FALLING,\
                                          sample_mode=Atype.FINITE,samps_per_chan=len(self.AOwaveform))
        self.DOtask.triggers.start_trigger.cfg_dig_edge_start_trig("/Robot/PFI0")
