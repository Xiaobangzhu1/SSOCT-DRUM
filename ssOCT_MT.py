...
from ThreadUVCamera import UVCameraThread
class CameraThread_2(UVCameraThread):
    def __init__(self, ui, log):
        super().__init__()
        self.ui = ui
        self.log = log
...
from ThreadUVLight import UVLightThread
class LightThread_2(UVLightThread):
    def __init__(self, ui, log):
        super().__init__()
        self.ui = ui
        self.log = log
...
class GUI(MainWindow):
    def __init__(self):
        ...
        # set UV camera parameters
        self.ui.Exposure.valueChanged.connect(self.update_Exposure)
        self.ui.Gain.valueChanged.connect(self.update_Gain)
    ...
    def Init_allThreads(self):
        ...
        self.C_thread = CameraThread_2(self.ui, self.log)
        self.C_thread.start()
        
        self.L_thread = LightThread_2(self.ui, self.log)
        self.L_thread.start()
    ...
    def update_Exposure(self):
        an_action = UVCameraAction('update_Exposure')
        CQueue.put(an_action)
    
    def AutoExposure(self):
        an_action = UVCameraAction('AutoExposure')
        CQueue.put(an_action)
        
    def update_Gain(self):
        an_action = UVCameraAction('update_Gain')
        CQueue.put(an_action)
        
    def AutoGain(self):
        an_action = UVCameraAction('AutoGain')
        CQueue.put(an_action)
